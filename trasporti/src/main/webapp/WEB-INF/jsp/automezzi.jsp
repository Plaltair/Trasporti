...
<body>
	...
	<c:if test="${alreadyExists == true}">
		<div align="center">
			<h5><span class="badge badge-pill badge-danger">Non è stato possibile inserire l'automezzo, perché la targa risulta già esistente.</span></h5>
		</div>
		<br>
	</c:if>
	<c:if test="${alreadyExists == false}">
		<div align="center">
			<h5><span class="badge badge-pill badge-success">Automezzo inserito con successo.</span></h5>
		</div>
		<br>
	</c:if>
	...
	<table class="table">
		...
		<tbody align="center" id="table_automezzi">
			...
			<tr>
				<td><a href="/aggiungi_automezzo"> <button type="button" class="btn btn-primary">Aggiungi automezzo</button> </a></td>
				<td></td>
			</tr>
		</tbody>
	</table>
